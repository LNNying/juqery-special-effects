...
// 第一个里程碑
let firstMilepost = null;
// 第二个里程碑
let sconedMilepost = null;
// 地图定时器
...
// 公司里程碑文本循环时间
const MILEPOST_TEXT_TIME = 2000;
// 地图循环显示速度
const MAP_INTO_TIME = 5000;
// 公司动态和公司通知循环时间;
const DY_NO_TIME = 15000;
// 公司里程碑第一部分
...
function returnVideoOrSubtitle(obj, type, isFullScreen) {
    if (isFullScreen) {
        ...
        if (type !== '0') {
            ...
            background-image: url(${obj.imgSrc});
            font-size: ${obj.fontSize};"><div class="lnn-small-sub-title">${obj.text}</div></div>`;
        }
    }
}
