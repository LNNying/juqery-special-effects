...
$(function () {
    ...
    function firstMilepostFlip() {
        ...
        let dateList = handleTimeType(milepostDataList[firstIndex].createTime, 'y-m-d').split('-');
        let year = dateList[0];
    ...
    function secondMilepostFlip() {
        ...
        let dateList = handleTimeType(milepostDataList[secondIndex].createTime, 'y-m-d').split('-');
        let year = dateList[0];
        let month = dateList[1];
